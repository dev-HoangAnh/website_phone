...
<body>
    ...
    <div class="mb-3 mt-3">
        ...
        <div class="mb-3 mt-3">
            <label for="Caregory" class="form-label">Category:</label>
            <input type="float" class="form-control" id="category" placeholder="Enter category" value="{{ $product['category'] }}" name="category">
        </div>
        <div class="mb-3 mt-3">
